...
rem ============================================================
rem  Pasa el checkout a la rama frontend-react
rem  Uso: frontend-on.bat [ -q ]   (-q = sin pausa, para scripts)
rem ============================================================

set "TARGET=frontend-react"
set "FOLDER=frontend-react"
set "OTHER=backend-laravel"
set "PAUSEQ="
